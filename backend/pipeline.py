...
def load_vector_database_documents():
    ...
    for document in preprocessed_dicts:
        try:
            ...
            print(f"##### Something went wrong. Skipping document {document_index}\n")
            document_index += 1
            continue
    return return_list
...
if __name__ == "__main__":
    list_of_vectors = load_vector_database_documents()

    with open("documents_for_vector.json", "w") as final:
        dump(list_of_vectors, final)